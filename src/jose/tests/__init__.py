...
def _S(o):      # int array to string
    return ''.join([chr(i) for i in o])


def _BE(s):     # b64encode
    return base64.base64url_encode(s)


def _BD(s):     # b64decode
    return base64.base64url_decode(s)
...
class JWK_THUMBPRINT:
    '''
https://tools.ietf.org/html/draft-ietf-jose-jwk-thumbprint-01#section-3.1
    '''
    n = "".join([
    ...
    thumbprint_value_b64 = 'NzbLsXh8uDCcd-6MNwXF4W_7noWXFZAfHkxZsRGC9Xs'
